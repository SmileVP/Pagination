...
des.innerHTML = "Access your pages in an easy manner";
...
//to create a table container

let table_parent = document.createElement("div");
table_parent.setAttribute("class", "table-responsive");
table_parent.setAttribute("id", "table_content");
main_container.append(table_parent);

//to create table

let table_outer = document.createElement("table");
table_outer.setAttribute("class", "table table-bordered");
table_outer.setAttribute("id", "table");
table_parent.append(table_outer);

//to create the table list

let table_head = document.createElement("thead");
table_outer.append(table_head);

let table_body = document.createElement("tbody");
table_body.setAttribute("id", "t_content");
table_outer.append(table_body);
...
//to create buttons
let pagination_ele = document.createElement("div");
pagination_ele.setAttribute("id", "buttons");
pagination_ele.setAttribute("class", "d-flex justify-content:center");
main_container.append(pagination_ele);

let first_button = document.createElement("button");
first_button.setAttribute("id", "first");
first_button.innerHTML = "First";
pagination_ele.append(first_button);

let previous_button = document.createElement("button");
previous_button.setAttribute("id", "prev");
previous_button.innerHTML = "Prev";
pagination_ele.append(previous_button);

//to create buttons for numbers
for (let i = 0; i < 10; i++) {
  let button = document.createElement("button");
  button.setAttribute("class", "button_no");
  button.setAttribute("id", i + 1);
  button.innerHTML = i + 1;
  pagination_ele.append(button);

  //event for number buttons
  button.addEventListener("click", () => {
    let x = button.innerHTML;
    clicked_button = x;
    let b = 10;
    let m = document.getElementById("t_content");
    let content = "";
...
pagination_ele.append(next_button);

let last_button = document.createElement("button");
last_button.setAttribute("id", "last");
last_button.innerHTML = "Last";
pagination_ele.append(last_button);
